    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          <span className="material-symbols-outlined text-3xl text-blue-600">privacy_tip</span>
        ...
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          ...
          <h2 className="text-base font-bold text-slate-800 mt-6">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-base font-bold text-slate-800 mt-6">2. How We Use Your Information</h2>
          ...
          <h2 className="text-base font-bold text-slate-800 mt-6">3. Data Security</h2>
          <p>
          ...
          <h2 className="text-base font-bold text-slate-800 mt-6">4. Your Rights</h2>
          <p>
            You have the right to access, correct, or delete your personal information at any time.
            To exercise these rights, please contact us using the information below.
          </p>

          <h2 className="text-base font-bold text-slate-800 mt-6">5. Data Retention</h2>
          <p>
            We retain your information only for as long as necessary to provide our services and comply with legal obligations.
          </p>

          <h2 className="text-base font-bold text-slate-800 mt-6">6. Third-Party Services</h2>
          <p>
            We may use third-party services (e.g., Cloudinary for image storage) that have their own privacy policies.
            We encourage you to review their policies.
          </p>

          <h2 className="text-base font-bold text-slate-800 mt-6">7. Changes to This Policy</h2>
          <p>
            We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page.
          </p>

          <h2 className="text-base font-bold text-slate-800 mt-6">8. Contact Us</h2>
